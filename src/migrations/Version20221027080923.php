 ...
 */
final class Version20221027080923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, id_user_id INT DEFAULT NULL, tag_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, price INT NOT NULL, date DATETIME NOT NULL, INDEX IDX_F65593E579F37AE5 (id_user_id), INDEX IDX_F65593E5BAD26311 (tag_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE answer (id INT AUTO_INCREMENT NOT NULL, id_question_id INT NOT NULL, id_user_id INT NOT NULL, answer VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_DADD4A256353B48 (id_question_id), INDEX IDX_DADD4A2579F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, id_annonce_id INT NOT NULL, id_user_id INT NOT NULL, id_answer_id INT DEFAULT NULL, question VARCHAR(255) NOT NULL, INDEX IDX_B6F7494E2D8F2BF8 (id_annonce_id), INDEX IDX_B6F7494E79F37AE5 (id_user_id), UNIQUE INDEX UNIQ_B6F7494E2A06F420 (id_answer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
